        ...
        <form  name="myform" action="UpdateServlet" method="post"> 
          <table width="85%" border="0" align=center cellpadding=3 cellspacing=2 bordercolor="#FFFFFF" bgcolor="#FFFFFF" class=i_table> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td width=78% align="left"  class='f_one'><input name='txt_regname' type="text" id="txt_regname" value='<%=user.getUsername() %>' size=20 maxlength=14> 
                <font color=red>*</font> 
              <div id="check_info"></div></td> 
            </tr> 
            <tr bgcolor="#FFFFFF"> 
              <td align="right" valign=middle > 真实姓名</td> 
              <td align="left" > <input name="txt_regrealname" type=text id="txt_regrealname" size=20 maxlength=75 value="<%=user.getName() %>">                
              <font color=red>*</font></td> 
            </tr> 
            <tr> 
            <tr bgcolor="#FFFFFF"> 
              <td align="right" valign=middle > 密码</td> 
              <td align="left"> <input name="txt_regpwd" type="text" id="txt_regpwd" size=20 maxlength=75 value="<%=user.getPassword() %>"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td align="left" > <span class="word_grey"> 
                <input name="txt_birthday" type="text" id="control_date" size="10" maxlength="10" readonly="readonly" value="<%=user.getBirthdate()  %>"> 
            ...
            <tr bgcolor="#FFFFFF"> 
              ...
              <td align="left"  > <input name="txt_regemail" type="text" id="txt_regemail" value='' size=35 maxlength=75 value="<%=user.getEmail() %>"> 
          ...
          <br> 
            <input type='submit' name='update' value='确认修改'class="btn_grey" onClick="return check()"> &nbsp;
